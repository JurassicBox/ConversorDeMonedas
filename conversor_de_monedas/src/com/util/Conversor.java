...
public class Conversor {
    ...
    public static void ejecute()  {
        ...
        System.out.println("-----------------------------------------------");
        System.out.println("Bienvenido/a al programa de conversor de moneda de \n Porfavor elige una de las opciones");

        while (!salida) {

            System.out.println("1) Ver el tablero de conversiones disponibles");
                ...
                switch (eleccion) {
                    ...
                    case 2:
                        ...
                        try {
                            ...
                            if (result == null) {
                                System.out.println("Paises mal ingresados, porfavor revise nuevamente el tablero");
                            } else {
                                System.out.println(result);
                                historial.add(result);
                            }
                        } catch (NumberFormatException e) {
                            System.out.println(" Error: Ingresar un número válido para el monto.");
                        } catch (Exception e) {
